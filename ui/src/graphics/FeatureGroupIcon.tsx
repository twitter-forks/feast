...
const FeatureGroupIcon16 = () => {
  return <FeatureGroupIcon size={16} className="euiSideNavItemButton__icon" />;
};

const FeatureGroupIcon32 = () => {
  return (
    <FeatureGroupIcon
      size={32}
...
export { FeatureGroupIcon, FeatureGroupIcon16, FeatureGroupIcon32 };
